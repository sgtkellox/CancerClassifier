...
class CNN_dropout(nn.Module):
    def __init__(self):
        ...
        self.fc1 = nn.Linear(in_features=100352, out_features=4000)   #Flattened image is fed into linear NN and reduced to half size
        ...
        self.droput = nn.Dropout(p=0.5)
        self.fc5 = nn.Linear(in_features=50, out_features=3)    #Since there were so many features, I decided to use 45 layers to get output layers. You can increase the kernels in Maxpooling to reduce image further and reduce number of hidden linear layers.
    ...
    def forward(self,x):
        ...
        out = out.view(-1,100352)   #-1 will automatically update the batchsize as 100; 8192 flattens 32,16,16
